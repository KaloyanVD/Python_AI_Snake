...
class Agent:
    ...
    def __init__(self):
        ...
        self.memory = deque(maxlen=MAX_MEMORY)  # popleft() if it gets filled
        self.model = Linear_QNet(11, 256, 3) # 11 different states, 3 diff outputs possible
    ...
    def get_state(self, game):
        ...
        # create points next to the head in all dirs
